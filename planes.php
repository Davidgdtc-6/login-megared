    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li class="active"><a href="planes.php"><i class="fas fa-file-invoice-dollar"></i> Planes</a></li>
        ...
        <main class="main-content">
            ...
            <section class="content-body">
                <h2 data-aos="fade-down">Planes Internet Megared</h2>

                <div class="card-large" data-aos="zoom-in">
                    <img src="Imagen/planesMG.png" alt="Planes Megared" class="plans-page-image">
                </div>
